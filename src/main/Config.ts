...
export namespace Config {
  export class Dispatcher {
    ...
    public static readonly from: string = 'potus@whitehouse.gov';

    private static readonly htmlHeader: string = 'This is a test message from <a href="https://mailsploit.com">Mailsploit.com</a>.<br /><br />';
    private static readonly plaintextHeader: string = 'This is a test message from Mailsploit.com.\r\n';
    private static readonly htmlFooter: string = '<br /><br />If you did not asked to try out Mailsploit, please contact @pwnsdx on Twitter.';
    private static readonly plaintextFooter: string = '\r\nIf you did not asked to try out Mailsploit, please contact @pwnsdx on Twitter.';

    public static readonly htmlBody: string = `${
      Dispatcher.htmlHeader
    }If you are using a vulnerable mail client you should <b>see that this e-mail come from potus@whitehouse.gov</b>.${
      Dispatcher.htmlFooter
    }`;
    public static readonly plaintextBody: string = `${
      Dispatcher.plaintextHeader
    }If you are using a vulnerable mail client you should see that this e-mail come from potus@whitehouse.gov.${
